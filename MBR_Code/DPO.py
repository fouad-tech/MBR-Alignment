...
if __name__ == "__main__":
    ...
    parser.add_argument('--BasePath', default='../model-based-mbr/DPO', help=' directory to save the checkpoints and results')
    ...
    training_args = DPOConfig(
        ...
        save_strategy='steps',
        save_steps = math.ceil(totalSteps), #math.ceil(totalSteps*0.25),
        optim=args.optim,
